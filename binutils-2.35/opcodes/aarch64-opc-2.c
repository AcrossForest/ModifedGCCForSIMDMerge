...
const struct aarch64_operand aarch64_operands[] =
{
  ...
  {AARCH64_OPND_CLASS_SIMD_REG, "SPSP_OP0V", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_OPCODE0}, "a SIMD register"},
  {AARCH64_OPND_CLASS_SIMD_REG, "SPSP_OP1V", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_OPCODE1}, "a SIMD register"},
  {AARCH64_OPND_CLASS_SIMD_REG, "SPSP_OP2V", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_OPCODE2}, "a SIMD register"},
  {AARCH64_OPND_CLASS_SIMD_REG, "SPSP_OP3V", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_OPCODE3}, "a SIMD register"},
  {AARCH64_OPND_CLASS_PRED_REG, "SPSP_OP0P", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_OPCODE0_AsPred}, "an SVE predicate register"},
  {AARCH64_OPND_CLASS_PRED_REG, "SPSP_OP1P", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_OPCODE1_AsPred}, "an SVE predicate register"},
  {AARCH64_OPND_CLASS_PRED_REG, "SPSP_OP2P", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_OPCODE2_AsPred}, "an SVE predicate register"},
  {AARCH64_OPND_CLASS_PRED_REG, "SPSP_OP3P", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_OPCODE3_AsPred}, "an SVE predicate register"},
  {AARCH64_OPND_CLASS_INT_REG, "SPSP_OP0R", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_OPCODE0}, "an integer register"},
  {AARCH64_OPND_CLASS_INT_REG, "SPSP_OP1R", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_OPCODE1}, "an integer register"},
  {AARCH64_OPND_CLASS_INT_REG, "SPSP_OP2R", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_OPCODE2}, "an integer register"},
  {AARCH64_OPND_CLASS_INT_REG, "SPSP_OP3R", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_OPCODE3}, "an integer register"},
  {AARCH64_OPND_CLASS_IMMEDIATE, "SPSP_IMM", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_SPSP_IMM}, "an immediate number of 4 bit"},
