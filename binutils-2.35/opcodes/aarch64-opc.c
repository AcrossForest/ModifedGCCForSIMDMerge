		       ...
		       bfd_vma *address, char** notes)
{
  ...
  switch (opnd->type)
    ...
    case AARCH64_OPND_SPSP_OP0R:
    case AARCH64_OPND_SPSP_OP1R:
    case AARCH64_OPND_SPSP_OP2R:
    case AARCH64_OPND_SPSP_OP3R:
    ...
    case AARCH64_OPND_SPSP_OP0P:
    case AARCH64_OPND_SPSP_OP1P:
    case AARCH64_OPND_SPSP_OP2P:
    case AARCH64_OPND_SPSP_OP3P:
    ...
    case AARCH64_OPND_SPSP_OP0V:
    case AARCH64_OPND_SPSP_OP1V:
    case AARCH64_OPND_SPSP_OP2V:
    case AARCH64_OPND_SPSP_OP3V:
      if (opnd->qualifier == AARCH64_OPND_QLF_NIL)
