...
#define SPSPOPCODE(id) (((0b0001)<<25) | ((id & 0b1000) << (24-3)) | ((id & 0b0111) << 29))
...
/* Crypto SHA2 (optional in ARMv8.2-a).  */
  ...
  CORE_INSN("spsp_pack",SPSPOPCODE(0),0xff000000,sve_misc, 0, OP3(SPSP_OP0R,SPSP_OP1R,SPSP_OP2R),{QLF3(X,X,X)},0),
  CORE_INSN("spsp_idx_comp_init_m1",SPSPOPCODE(1),0xff000000,sve_misc, 0, OP4(SPSP_OP0V,SPSP_OP1V,SPSP_OP2V,SPSP_OP3R),{QLF4(S_S,S_S,S_S,X)},0),
  CORE_INSN("spsp_idx_get_length",SPSPOPCODE(2),0xff000000,sve_misc, 0, OP3(SPSP_OP0R,SPSP_OP1V,SPSP_IMM),{QLF3(X,S_S,NIL)},0),
  CORE_INSN("spsp_idx_comp",SPSPOPCODE(3),0xff000000,sve_misc, 0, OP3(SPSP_OP0V,SPSP_OP1V,SPSP_OP2V),{QLF3(S_S,S_S,S_S)},0),
  CORE_INSN("spsp_idx_match_m1",SPSPOPCODE(4),0xff000000,sve_misc, 0, OP4(SPSP_OP0V,SPSP_OP1V,SPSP_OP2R,SPSP_IMM),{QLF4(S_S,S_S,X,NIL)},0),
  CORE_INSN("spsp_idx_match_m2",SPSPOPCODE(5),0xff000000,sve_misc, 0, OP4(SPSP_OP0V,SPSP_OP1R,SPSP_OP2R,SPSP_IMM),{QLF4(S_S,X,X,NIL)},0),
  CORE_INSN("spsp_cust_perm",SPSPOPCODE(6),0xff000000,sve_misc, 0, OP4(SPSP_OP0V,SPSP_OP1V,SPSP_OP2V,SPSP_IMM),{QLF4(S_S,S_S,S_S,NIL)},0),
  CORE_INSN("spsp_cust_get_pred",SPSPOPCODE(7),0xff000000,sve_misc, 0, OP3(SPSP_OP0P,SPSP_OP1V,SPSP_IMM),{QLF3(S_S,S_S,NIL)},0),
  
  CORE_INSN("spsp_init_big_cmp",SPSPOPCODE(8),0xff000000,sve_misc, 0, OP4(SPSP_OP0V,SPSP_OP1R,SPSP_OP2P,SPSP_OP3P),{QLF4(S_S,X,S_S,S_S)},0),
  CORE_INSN("spsp_next_big_cmp_from_mat_res",SPSPOPCODE(9),0xff000000,sve_misc, 0, OP3(SPSP_OP0V,SPSP_OP1R,SPSP_OP2V),{QLF3(S_S,X,S_S)},0),
  CORE_INSN("spsp_key_combine",SPSPOPCODE(10),0xff000000,sve_misc, 0, OP5(SPSP_OP0V,SPSP_OP1V,SPSP_OP2V,SPSP_OP3V,SPSP_IMM),{QLF5(S_S,S_S,S_S,S_S,NIL)},0),
  CORE_INSN("spsp_match",SPSPOPCODE(11),0xff000000,sve_misc, 0, OP4(SPSP_OP0V,SPSP_OP1V,SPSP_OP2R,SPSP_OP3R),{QLF4(S_S,S_S,X,X)},0),
  CORE_INSN("spsp_get_limit",SPSPOPCODE(12),0xff000000,sve_misc, 0, OP4(SPSP_OP0R,SPSP_OP1V,SPSP_OP2R,SPSP_OP3R),{QLF4(X,S_S,X,X)},0),
  CORE_INSN("spsp_bf_permute",SPSPOPCODE(13),0xff000000,sve_misc, 0, OP5(SPSP_OP0V,SPSP_OP1V,SPSP_OP2V,SPSP_OP3V,SPSP_IMM),{QLF5(S_S,S_S,S_S,S_S,NIL)},0),
  CORE_INSN("spsp_se_permute",SPSPOPCODE(14),0xff000000,sve_misc, 0, OP5(SPSP_OP0V,SPSP_OP1V,SPSP_OP2V,SPSP_OP3R,SPSP_IMM),{QLF5(S_S,S_S,S_S,X,NIL)},0),
  
  // CORE_INSN("spsp_single_side_sort_init",SPSPOPCODE(8),0xff000000,sve_misc, 0, OP3(SPSP_OP0V,SPSP_OP1V,SPSP_OP2P),{QLF3(S_S,S_S,S_S)},0),
  // CORE_INSN("spsp_single_side_sort",SPSPOPCODE(9),0xff000000,sve_misc, 0, OP3(SPSP_OP0V,SPSP_OP1V,SPSP_OP2P),{QLF3(S_S,S_S,S_S)},0),
  // CORE_INSN("spsp_diff",SPSPOPCODE(10),0xff000000,sve_misc, 0, OP3(SPSP_OP0P,SPSP_OP1V,SPSP_OP2R),{QLF3(S_S,S_S,X)},0),
  // CORE_INSN("spsp_encoding",SPSPOPCODE(11),0xff000000,sve_misc, 0, OP2(SPSP_OP0V,SPSP_OP1P),{QLF2(S_S,S_S)},0),
  // CORE_INSN("spsp_cust_last_act_elem",SPSPOPCODE(12),0xff000000,sve_misc, 0, OP4(SPSP_OP0R,SPSP_OP1V,SPSP_OP2V,SPSP_IMM),{QLF4(X,S_S,S_S,NIL)},0),
  // CORE_INSN("spsp_ring_load",SPSPOPCODE(13),0xff000000,sve_misc, 0, OP4(SPSP_OP0V,SPSP_OP1P,SPSP_OP2R,SPSP_OP3R),{QLF4(S_S,S_S,X,X)},0),
  // CORE_INSN("spsp_ring_store",SPSPOPCODE(14),0xff000000,sve_misc, 0, OP4(SPSP_OP0V,SPSP_OP1P,SPSP_OP2R,SPSP_OP3R),{QLF4(S_S,S_S,X,X)},0),
  CORE_INSN("spsp_test_add",SPSPOPCODE(15),0xff000000,sve_misc, 0, OP3(SPSP_OP0V,SPSP_OP1V,SPSP_OP2V),{QLF3(S_S,S_S,S_S)},0),
...
#define AARCH64_OPERANDS						\
    ...
    Y(SIMD_REG, regno, "SPSP_OP0V", 0, F(FLD_SPSP_OPCODE0), "a SIMD register")\
    Y(SIMD_REG, regno, "SPSP_OP1V", 0, F(FLD_SPSP_OPCODE1), "a SIMD register")\
    Y(SIMD_REG, regno, "SPSP_OP2V", 0, F(FLD_SPSP_OPCODE2), "a SIMD register")\
    Y(SIMD_REG, regno, "SPSP_OP3V", 0, F(FLD_SPSP_OPCODE3), "a SIMD register")\
    Y(PRED_REG, regno, "SPSP_OP0P", 0, F(FLD_SPSP_OPCODE0_AsPred), "an SVE predicate register") \
    Y(PRED_REG, regno, "SPSP_OP1P", 0, F(FLD_SPSP_OPCODE1_AsPred), "an SVE predicate register") \
    Y(PRED_REG, regno, "SPSP_OP2P", 0, F(FLD_SPSP_OPCODE2_AsPred), "an SVE predicate register") \
    Y(PRED_REG, regno, "SPSP_OP3P", 0, F(FLD_SPSP_OPCODE3_AsPred), "an SVE predicate register") \
    Y(INT_REG, regno, "SPSP_OP0R", 0, F(FLD_SPSP_OPCODE0), "an integer register")\
    Y(INT_REG, regno, "SPSP_OP1R", 0, F(FLD_SPSP_OPCODE1), "an integer register")\
    Y(INT_REG, regno, "SPSP_OP2R", 0, F(FLD_SPSP_OPCODE2), "an integer register")\
    Y(INT_REG, regno, "SPSP_OP3R", 0, F(FLD_SPSP_OPCODE3), "an integer register")\
    Y(IMMEDIATE, imm, "SPSP_IMM", 0, F(FLD_SPSP_IMM),	"an immediate number of 4 bit")	\


    // {  0,  5 }, /* FLD_SPSP_OPCODE0: SpSp Instruction fields  */
    // {  0,  4 }, /* FLD_SPSP_OPCODE0_AsPred: SpSp Instruction fields  */
    // {  5,  5 }, /* FLD_SPSP_OPCODE1: SpSp Instruction fields  */
    // {  5,  4 }, /* FLD_SPSP_OPCODE1_AsPred: SpSp Instruction fields  */
    // {  10, 5 }, /* FLD_SPSP_OPCODE2: SpSp Instruction fields  */
    // {  10, 4 }, /* FLD_SPSP_OPCODE2_AsPred: SpSp Instruction fields  */
    // {  15, 5 }, /* FLD_SPSP_OPCODE3: SpSp Instruction fields  */
    // {  15, 4 }, /* FLD_SPSP_OPCODE3_AsPred: SpSp Instruction fields  */
    // {  20, 4 }, /* FLD_SPSP_IMM: SpSp Instruction fields  */
