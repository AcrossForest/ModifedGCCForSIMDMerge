...
namespace aarch64_sve
{
  namespace functions
  {
    ...
    extern const function_base *const svSpSpInitBigCmp;
    extern const function_base *const svSpSpInitBigCmpFromMatRes;
    extern const function_base *const svSpSpKeyCombine;
    extern const function_base *const svSpSpMatch;
    extern const function_base *const svSpSpGetLimit;
    extern const function_base *const svSpSpBFPermute;
    extern const function_base *const svSpSpSEPermute;

    extern const function_base *const svSpSpPack;
    extern const function_base *const svSpSpIndexCompressInitM1;
    extern const function_base *const svSpSpGetLength;
    extern const function_base *const svSpSpIndexCompressInitM2;
    extern const function_base *const svSpSpIndexCompression;
    extern const function_base *const svSpSpIndexMatchM1;
    extern const function_base *const svSpSpIndexMatchM2;
    extern const function_base *const svSpSpCustPerm;
    extern const function_base *const svSpSpGetPred;
    extern const function_base *const svSpSpSingleSideSortInit;
    extern const function_base *const svSpSpSingleSideSort;
    extern const function_base *const svSpSpDiff;
    extern const function_base *const svSpSpEncoding;
    extern const function_base *const svSpSpCustLastActElem;
    extern const function_base *const svSpSpRingLoad;
    extern const function_base *const svSpSpRingStore;
    extern const function_base *const svindex_compress;
    extern const function_base *const svring_load;
