...
#define SPSPMYSHAPE(CNAME,PATTERNSTRING) \
struct MyCustomShape_##CNAME##_def : public nonoverloaded_base\
{\
  void\
  build (function_builder &b, const function_group_info &group) const OVERRIDE\
  {\
    build_all (b, PATTERNSTRING, group, MODE_none);\
  }\
};\
  static CONSTEXPR const MyCustomShape_##CNAME##_def CNAME##_Shape_obj; \
  namespace shapes { const function_shape *const SpSp_##CNAME##_Shape = &CNAME##_Shape_obj; }

#define SPSPMYSHAPEWithIMM(CNAME,PATTERNSTRING,IMMLOC,MIN,MAX) \
struct MyCustomShape_##CNAME##_def : public nonoverloaded_base\
{\
  void\
  build (function_builder &b, const function_group_info &group) const OVERRIDE\
  ...
  check (function_checker &c) const OVERRIDE\
  {\
    return c.require_immediate_range (IMMLOC, MIN, MAX);\
  }\
};\
  static CONSTEXPR const MyCustomShape_##CNAME##_def CNAME##_Shape_obj; \
  namespace shapes { const function_shape *const SpSp_##CNAME##_Shape = &CNAME##_Shape_obj; }

// SPSPMYSHAPE(encoding,"vu32,vp")

SPSPMYSHAPE(svSpSpInitBigCmp,"vu32,su64,vp,vp")
SPSPMYSHAPE(svSpSpInitBigCmpFromMatRes,"vu32,su64,vu32")
SPSPMYSHAPEWithIMM(svSpSpKeyCombine,"vu32,vu32,v0,v0,su64",3,0,3)
SPSPMYSHAPE(svSpSpMatch,"vu32,vu32,su64,su64")
SPSPMYSHAPE(svSpSpGetLimit,"su64,vu32,su64,su64")
SPSPMYSHAPEWithIMM(svSpSpBFPermute,"v0,vu32,v0,v0,su64",3,0,1)
SPSPMYSHAPEWithIMM(svSpSpSEPermute,"v0,vu32,v0,su64,su64",3,0,3)


SPSPMYSHAPE(svSpSpPack,"su64,su64,su64")
SPSPMYSHAPE(svSpSpIndexCompressInitM1,"vu32,vu32,vu32,su64")
// SPSPMYSHAPE(svSpSpGetLength,"su64,vu32,su64")
SPSPMYSHAPEWithIMM(svSpSpGetLength,"su64,vu32,su64",1,0,4)
SPSPMYSHAPE(svSpSpIndexCompressInitM2,"vu32,su64,su64")
SPSPMYSHAPE(svSpSpIndexCompression,"vu32,vu32,vu32,vu32")
SPSPMYSHAPEWithIMM(svSpSpIndexMatchM1,"vu32,vu32,su64,su64",2,0,7)
SPSPMYSHAPEWithIMM(svSpSpIndexMatchM2,"vu32,vu32,su64,su64,su64",3,0,7)
SPSPMYSHAPEWithIMM(svSpSpCustPerm,"v0,vu32,v0,su64",2,0,3)
SPSPMYSHAPEWithIMM(svSpSpGetPred,"vp,vu32,su64",1,0,7)
SPSPMYSHAPE(svSpSpSingleSideSortInit,"vu32,vu32,vp")
SPSPMYSHAPE(svSpSpSingleSideSort,"vu32,vu32,vu32,vp")
SPSPMYSHAPE(svSpSpDiff,"vp,vu32,su32")
SPSPMYSHAPE(svSpSpEncoding,"vu32,vp")
SPSPMYSHAPEWithIMM(svSpSpCustLastActElem,"su32,vu32,vu32,su64",2,0,3)
SPSPMYSHAPE(svSpSpRingLoad,"v0,vp,al,su64")
SPSPMYSHAPE(svSpSpRingStore,"_,v0,vp,as,su64")



#undef SPSPMYSHAPE
#undef SPSPMYSHAPEWithIMM
