...
namespace aarch64_sve
{
  ...
  namespace shapes
  {
    ...
    // extern const function_shape *const encodingShape;
#define DEF_SPSP(CName)\
   extern const function_shape *const SpSp_##CName##_Shape;

DEF_SPSP (svSpSpInitBigCmp)   // The version 2 of SpSp instructions
DEF_SPSP (svSpSpInitBigCmpFromMatRes)   // The version 2 of SpSp instructions
DEF_SPSP (svSpSpKeyCombine)   // The version 2 of SpSp instructions
DEF_SPSP (svSpSpMatch)   // The version 2 of SpSp instructions
DEF_SPSP (svSpSpGetLimit)   // The version 2 of SpSp instructions
DEF_SPSP (svSpSpBFPermute)   // The version 2 of SpSp instructions
DEF_SPSP (svSpSpSEPermute)   // The version 2 of SpSp instructions

DEF_SPSP (svSpSpPack)
DEF_SPSP (svSpSpIndexCompressInitM1)
DEF_SPSP (svSpSpGetLength)
DEF_SPSP (svSpSpIndexCompressInitM2)
DEF_SPSP (svSpSpIndexCompression)
DEF_SPSP (svSpSpIndexMatchM1)
DEF_SPSP (svSpSpIndexMatchM2)
DEF_SPSP (svSpSpCustPerm)
DEF_SPSP (svSpSpGetPred)
DEF_SPSP (svSpSpSingleSideSortInit)
DEF_SPSP (svSpSpSingleSideSort)
DEF_SPSP (svSpSpDiff)
DEF_SPSP (svSpSpEncoding)
DEF_SPSP (svSpSpCustLastActElem)
DEF_SPSP (svSpSpRingLoad)
DEF_SPSP (svSpSpRingStore)
#undef DEF_SPSP
  }
}
