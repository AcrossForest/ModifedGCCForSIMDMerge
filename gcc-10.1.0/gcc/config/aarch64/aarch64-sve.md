...
(define_insn "aarch64_sve_SpSp_init_big_cmp"
	[(set (match_operand:VNx4SI 0 "register_operand" "=w")
		(unspec:VNx4SI
			[
				(match_operand:DI 1 "register_operand" "r")
			 	(match_operand:VNx4BI 2 "register_operand" "Upl")
			 	(match_operand:VNx4BI 3 "register_operand" "Upl")
			]
			UNSPEC_SPSP_INIT_BIG_CMP
		)
	)]
	"TARGET_SVE"
	"spsp_init_big_cmp\\t%0.s,%1,%2.s,%3.s"
)

(define_insn "aarch64_sve_SpSp_init_big_cmp_from_mat_res"
	[(set (match_operand:VNx4SI 0 "register_operand" "=w")
		(unspec:VNx4SI
			[
				(match_operand:DI 1 "register_operand" "r")
			...
			UNSPEC_SPSP_INIT_BIG_CMP_FROM_MAT_RES
		)
	)]
	"TARGET_SVE"
	"spsp_next_big_cmp_from_mat_res\\t%0.s,%1,%2.s"
)

(define_insn "@aarch64_sve_SpSp_key_combine<mode>"
	[(set (match_operand:VNx4SI 0 "register_operand" "=w")
		(unspec:VNx4SI
			[
			 	(match_operand:VNx4SI 1 "register_operand" "w")
			 	(match_operand:SVE_FULL_S 2 "register_operand" "w")
			 	(match_operand:SVE_FULL_S 3 "register_operand" "w")
			 	(match_operand:DI 4 "immediate_operand" "i")
			]
			UNSPEC_SPSP_KEY_COMBINE
		)
	)]
	"TARGET_SVE"
	"spsp_key_combine\\t%0.s,%1.s,%2.s,%3.s,%4"
)

(define_insn "aarch64_sve_SpSp_match"
	[(set (match_operand:VNx4SI 0 "register_operand" "=w")
		(unspec:VNx4SI
			[
			 	(match_operand:VNx4SI 1 "register_operand" "w")
	...
	"TARGET_SVE"
	"spsp_match\\t%0.s,%1.s,%2,%3"
)

(define_insn "aarch64_sve_SpSp_get_limit"
	[(set (match_operand:DI 0 "register_operand" "=r")
		(unspec:DI
			...
			UNSPEC_SPSP_GET_LIMIT
		)
	)]
	"TARGET_SVE"
	"spsp_get_limit\\t%0,%1.s,%2,%3"
)


(define_insn "@aarch64_sve_SpSp_bf_permute<mode>"
	[(set (match_operand:SVE_FULL_S 0 "register_operand" "=w")
		(unspec:SVE_FULL_S
			[
			 	(match_operand:VNx4SI 1 "register_operand" "w")
				(match_operand:SVE_FULL_S 2 "register_operand" "w")
			...
			UNSPEC_SPSP_BF_PERMUTE
		)
	)]
	"TARGET_SVE"
	"spsp_bf_permute\\t%0.s,%1.s,%2.s,%3.s,%4"
)

(define_insn "@aarch64_sve_SpSp_se_permute<mode>"
	[(set (match_operand:SVE_FULL_S 0 "register_operand" "=w")
		(unspec:SVE_FULL_S
			[
			 	(match_operand:VNx4SI 1 "register_operand" "w")
			...
			UNSPEC_SPSP_SE_PERMUTE
		)
	)]
	"TARGET_SVE"
	"spsp_se_permute\\t%0.s,%1.s,%2.s,%3,%4"
)



(define_insn "aarch64_sve_SpSp_pack"
	[(set (match_operand:DI 0 "register_operand" "=r")
		(unspec: DI
			[
				(match_operand:DI 1 "register_operand" "r")
...
(define_insn "aarch64_sve_SpSp_idxCompInit_method1"
	[(set (match_operand:VNx4SI 0 "register_operand" "=w")
		(unspec:VNx4SI
			[
				(match_operand:VNx4SI 1 "register_operand" "w")
			...
			UNSPEC_SPSP_IDXCOMPINIT_M1
		)
	)]
	"TARGET_SVE"
	"spsp_idx_comp_init_m1\\t%0.s,%1.s,%2.s,%3"
)

(define_insn "aarch64_sve_SpSp_getLength"
	[(set (match_operand:DI 0 "register_operand" "=r")
		(unspec:DI
			[
			 (match_operand:VNx4SI 1 "register_operand" "w")
			...
			UNSPEC_SPSP_GETLENGTH
		))]
	"TARGET_SVE"
	"spsp_idx_get_length \\t%0,%1.s,%2"
)

(define_insn "aarch64_sve_SpSp_idxCompInit_method2"
	[(set (match_operand:VNx4SI 0 "register_operand" "=w")
		(unspec:VNx4SI
			[
			 (match_operand:DI 1 "register_operand" "r")
			...
			UNSPEC_SPSP_IDXCOMPINIT_M2
		))]
	"TARGET_SVE"
	"spsp_idx_comp_init_m2\\t%0.s,%1,%2"
)

(define_insn "aarch64_sve_SpSp_idxComp"
	[(set (match_operand:VNx4SI 0 "register_operand" "=w,?&w")
		(unspec:VNx4SI
			[
				(match_operand:VNx4SI 1 "register_operand" "0,w")
				(match_operand:VNx4SI 2 "register_operand" "w,w")
				(match_operand:VNx4SI 3 "register_operand" "w,w")
			]
			UNSPEC_SPSP_IDXCOMP
		)
	)]
	"TARGET_SVE"
	"@
	spsp_idx_comp\\t%0.s,%2.s,%3.s
	movprfx\t%0, %1\;spsp_idx_comp\\t%0.s,%2.s,%3.s"
	[(set_attr "movprfx" "*,yes")]
)

(define_insn "aarch64_sve_SpSp_idxMatch_method1"
	[(set (match_operand:VNx4SI 0 "register_operand" "=w")
		(unspec:VNx4SI
			[
				(match_operand:VNx4SI 1 "register_operand" "w")
			...
			UNSPEC_SPSP_IDXMATCH_M1
		)
	)]
	"TARGET_SVE"
	"spsp_idx_match_m1\\t%0.s,%1.s,%2,#%3"
)

(define_insn "aarch64_sve_SpSp_idxMatch_method2"
	[(set (match_operand:VNx4SI 0 "register_operand" "=w,?&w")
		(unspec:VNx4SI
			[
				(match_operand:VNx4SI 1 "register_operand" "0,w")
			...
			UNSPEC_SPSP_IDXMATCH_M2
		)
	)]
	"TARGET_SVE"
	"@
	spsp_idx_match_m2\\t%0.s,%2,%3,#%4
	movprfx\t%0, %1\;spsp_idx_match_m2\\t%0.s,%2,%3,#%4"
	[(set_attr "movprfx" "*,yes")]
)

(define_insn "@aarch64_sve_SpSp_custPerm<mode>"
	[(set (match_operand:SVE_FULL_S 0 "register_operand" "=w")
		(unspec:SVE_FULL_S
			[
				(match_operand:VNx4SI 1 "register_operand" "w")
			...
			UNSPEC_SPSP_CUSTPERM
		)
	)]
	"TARGET_SVE"
	"spsp_cust_perm\\t%0.s,%1.s,%2.s,#%3"
)

(define_insn "aarch64_sve_SpSp_custGetPred"
	[(set (match_operand:VNx4BI 0 "register_operand" "=Upl")
		(unspec:VNx4BI
			[
				(match_operand:VNx4SI 1 "register_operand" "w")
				(match_operand:DI 2 "immediate_operand" "i")
	...
	"TARGET_SVE"
	"spsp_cust_get_pred\\t%0.s,%1.s,#%2"
)

(define_insn "aarch64_sve_SpSp_singleSideSortInit"
	[(set (match_operand:VNx4SI 0 "register_operand" "=w")
		(unspec:VNx4SI
			[
				(match_operand:VNx4SI 1 "register_operand" "w")
			...
			UNSPEC_SPSP_SINGLESIDESORTINIT
		)
	)]
	"TARGET_SVE"
	"spsp_single_side_sort_init\\t%0.s,%1.s,%2.s"
)

(define_insn "aarch64_sve_SpSp_singleSideSort"
	[(set (match_operand:VNx4SI 0 "register_operand" "=w,?&w")
		(unspec:VNx4SI
			[
				(match_operand:VNx4SI 1 "register_operand" "0,w")
				(match_operand:VNx4SI 2 "register_operand" "w,w")
				(match_operand:VNx4BI 3 "register_operand" "Upl,Upl")
			]
			UNSPEC_SPSP_SINGLESIDESORT
		)
	)]
	"TARGET_SVE"
	"@
	spsp_single_side_sort\\t%0.s,%2.s,%3.s
	movprfx\t%0, %1\;spsp_single_side_sort\\t%0.s,%2.s,%3.s"
	[(set_attr "movprfx" "*,yes")]

)

(define_insn "aarch64_sve_SpSp_diff"
	[(set (match_operand:VNx4BI 0 "register_operand" "=Upl")
		(unspec:VNx4BI
			[
				(match_operand:VNx4SI 1 "register_operand" "w")
...
(define_insn "aarch64_sve_SpSp_encoding"
	[(set (match_operand:VNx4SI 0 "register_operand" "=w")
		(unspec:VNx4SI
			[
				(match_operand:VNx4BI 1 "register_operand" "Upl")
			]
			UNSPEC_SPSP_ENCODING
		)
	)]
	"TARGET_SVE"
	"spsp_encoding\\t%0.s,%1.s"
)

(define_insn "aarch64_sve_SpSp_custLastActElem"
	[(set (match_operand:SI 0 "register_operand" "=r")
		(unspec:SI
			...
			UNSPEC_SPSP_CUSTLASTACTELEM
		)
	)]
	"TARGET_SVE"
	"spsp_cust_last_act_elem\\t%0,%1.s,%2.s,#%3"
)

(define_insn "@aarch64_sve_SpSp_ring_load_<mode>"
	[(set (match_operand:SVE_FULL_S 0 "register_operand" "=w")
		(unspec:SVE_FULL_S
			[
				(match_operand:VNx4BI 1 "register_operand" "Upl")
			...
			UNSPEC_SPSP_RING_LOAD_ADDR
		)
	)]
	"TARGET_SVE"
	"spsp_ring_load\\t%0.s,%1.s,%2,%3"
)

(define_insn "@aarch64_sve_SpSp_ring_store_<mode>"
	[(set (mem:BLK (scratch))
		(unspec:BLK
			[
				(match_operand:VNx4BI 1 "register_operand" "Upl")
				(match_operand:DI 2 "register_operand" "r")
				(match_operand:DI 3 "register_operand" "r")
				(match_operand:SVE_FULL_S 0 "register_operand" "w")
			]
			UNSPEC_SPSP_RING_STORE_ADDR
		)	
	)]
	"TARGET_SVE"
	"spsp_ring_store\\t%0.s,%1.s,%2,%3"
)



(define_insn "aarch64_sve_ring_load_vnx4sf"
  [(set (match_operand:VNx4SF 0 "register_operand" "=w, ?&w")
        (mem: VNx4SF
           (unspec: DI
              [(match_operand:VNx4BI 1 "register_operand" "Upl, Upl")
               (match_operand:DI 2 "register_operand" "r, r")
               (match_operand:DI 3 "register_operand" "r, r")]
            UNSPEC_RING_LOAD_ADDR)))]
  "TARGET_SVE"
  "vector_ring_load\\t%0.s, %1.s, %2, %3"
)

(define_insn "@aarch64_sve_<sve_fp_op>vnx4sf"
  [(set (match_operand:VNx4SF 0 "register_operand" "=w, ?&w")
        (unspec:VNx4SF
           [(match_operand:VNx4SF 1 "register_operand" "0, 0")
            (match_operand:VNx4SF 2 "register_operand" "w, w")
            (match_operand:VNx4SF 3 "register_operand" "w, w")]
         INDEX_COMPRESS))]
  "TARGET_SVE"
  "<sve_fp_op>\\t%0.s, %2.s, %3.s"
)
