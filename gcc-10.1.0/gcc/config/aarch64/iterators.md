...
(define_c_enum "unspec"
 [
	...
	UNSPEC_SPSP_INIT_BIG_CMP			; spsp version 2
	UNSPEC_SPSP_INIT_BIG_CMP_FROM_MAT_RES			; spsp version 2
	UNSPEC_SPSP_KEY_COMBINE			; spsp version 2
	UNSPEC_SPSP_MATCH			; spsp version 2
	UNSPEC_SPSP_GET_LIMIT			; spsp version 2
	UNSPEC_SPSP_BF_PERMUTE			; spsp version 2
	UNSPEC_SPSP_SE_PERMUTE			; spsp version 2
	UNSPEC_SPSP_PACK
    ...
    UNSPEC_INDEX_COMPRESS   ; Used in aarch64-sve.md.
    UNSPEC_RING_LOAD_ADDR   ; Used in aarch64-sve.md.
...
(define_int_iterator INDEX_COMPRESS [UNSPEC_INDEX_COMPRESS])
...
(define_int_attr sve_fp_op [(UNSPEC_BFDOT "bfdot")
			    ...
			    (UNSPEC_FMMLA "fmmla")
			    (UNSPEC_INDEX_COMPRESS "index_compress")
			    (UNSPEC_FTSMUL "ftsmul")
			    (UNSPEC_FTSSEL "ftssel")
